...
return [
    ...
    // Header Actions
    'view_location' => 'Դիտել տեղադրությունը',
    'last_updated_on' => 'Վերջին թարմացումը՝',
    ...
    'property_features' => 'Հատկանիշներ',
    'additional_details' => 'Լրացուցիչ',
    'about_property' => 'Գույքի մասին',
    'amenities' => 'Հարմարություններ',
    'floor_plan' => 'Հատակագիծ',
    'gallery' => 'Պատկերասրահ',
    'video' => 'Տեսանյութ',
    ...
    'tv' => 'Հեռուստացույց՝',
    'fridge' => 'Սառնարան՝',
    'water_purifier' => 'Ջրի մաքրիչ՝',
    'curtains' => 'Վարագույրներ՝',
    'yes' => 'Այո',
    'no' => 'Ոչ',
    ...
    // Floor Plans
    'balcony_plan' => 'Պատշգամբի հատակագիծ',
    'front_hall' => 'Մուտքի սրահ',
    'kitchen' => 'Խոհանոց',

    // FAQ Questions
    'faq_cancellation' => 'Առկա՞ է անվճար չեղարկում ամբողջական վերադարձով։',
    'faq_pool' => 'Կա՞ լողավազան։',
    'faq_pets' => 'Թույլատրվո՞ւմ են ընտանի կենդանիները։',
    'faq_shuttle' => 'Առաջարկվո՞ւմ է օդանավակայանի տրանսֆեր։',
    'faq_checkin' => 'Որո՞նք են ժամանման և մեկնելու ժամերը։',

    // FAQ Answers
    'faq_cancellation_answer' => 'Մենք առաջարկում ենք լիովին վերադարձվող սակագներ...',

    // Reviews
    'customer_reviews_ratings' => 'Հաճախորդների կարծիքներ և գնահատականներ',
    'based_on_reviews' => 'Հիմնված :count կարծիքի վրա',
    'write_review' => 'Գրել կարծիք',
    'rating' => 'Գնահատական',
    'write_your_review' => 'Գրեք ձեր կարծիքը',
    'submit_review' => 'Ուղարկել կարծիքը',
    'cancel' => 'Չեղարկել',
    'i_would_recommend' => 'Ես կառաջարկեի այս գույքը',
    'would_recommend' => 'Առաջարկում է',
    'verified' => 'Ստուգված',
    'email_label' => 'Էլ. փոստ',
    'star_ratings' => 'Աստղային գնահատականներ',
    'days_ago' => 'օր առաջ',
    'unforgettable_stay' => 'Անմոռանալի հանգիստ։',
    'excellent_service' => 'Գերազանց սպասարկում։',
    'convenient_location' => 'Հարմար տեղադրություն։',
    'reply' => 'Պատասխանել',
    ...
    'phone' => 'Հեռախոս',
    'your_phone' => 'Ձեր հեռախոսահամարը',
    'description_label' => 'Նկարագրություն',
    'submit' => 'Ուղարկել',
    'enquire_success' => 'Ձեր հարցումն ուղարկված է: Մենք կկապվենք ձեզ հետ շուտով:',
    'enquire_error' => 'Ինչ-որ բան սխալ գնաց: Խնդրում ենք կրկին փորձել:',
    'enquire_message_placeholder' => 'Գրեք Ձեր հարցը այս գույքի մասին...',

    // Transaction Types
    'rent_monthly' => 'Ամսական',
    'rent_daily' => 'Օրական',
    'for_sale' => 'Վաճառվում է',
    'per_day' => '/օր',

    // Property Details
    'rooms' => 'Սենյակներ՝',
    'area' => 'Մակերես՝',
    'no_amenities' => 'Հարմարություններ չկան։',
    'no_reviews_yet' => 'Կարծիքներ դեռ չկան։',
    'comments' => 'Մեկնաբանություններ',
    'no_comments_yet' => 'Մեկնաբանություններ դեռ չկան։',
    ...
    // Review sub-ratings
    'location_rating' => 'Գտնվելու վայր',
    'value_rating' => 'Գին/որակ',
    'condition_rating' => 'Վիճակ',
    'service_rating' => 'Սպասարկում',
    'recommended' => 'Խորհուրդ եմ տալիս',
    'helpful_votes' => ':count օգտակար',
    'owner_reply' => 'Սեփականատիրոջ պատասխան',

    // Share toast messages
    'link_copied' => 'Հղումը պատճենվեց!',
    'copy_failed' => 'Չհաջողվեց պատճենել',
    'copy_error' => 'Պատճենման սխալ',
    'share_text' => 'Կիսվել հիմա!',

    // Reviewer roles
    'role_admin' => 'Ադմինիստրատոր',
    'role_agent' => 'Գործակալ',
    'role_viewer' => 'Օգտատեր',
    'role_owner' => 'Սեփականատեր',

    // Section titles
    'similar_properties'     => 'Նմանատիպ հայտարարություններ',
    'appliances_section'     => 'Կենցաղային տեխնիկա',
    'utilities_section'      => 'Կոմունալ ծառայություններ',
    'features_section'       => 'Առանձնահատկություններ',
    'rental_conditions'      => 'Վարձակալության պայմաններ',
    'price_history'          => 'Գնի պատմություն',
    'extended_attributes'    => 'Լրացուցիչ տեղեկություններ',
    'specifications_section' => 'Բնութագրեր',
    ...
    'long_term_rental'  => 'Երկարաժամկետ վարձ',
    ...
    'renovation_old'          => 'Հին',
    'renovation_unrenovated'  => 'Անվերանորոգ',
    ...
    'furniture_by_agreement'  => 'Համաձայնությամբ',
    ...
    // Zoning
    'zoning_residential'  => 'Բնակելի',
    'zoning_commercial'   => 'Առևտրային',
    'zoning_industrial'   => 'Արդյունաբերական',
    'zoning_agricultural' => 'Գյուղատնտեսական',
    'zoning_mixed'        => 'Խառը',
    'zoning_type'         => 'Նշանակություն',
    ...
    'amenity_backupgenerator'       => 'Պահուստային գեներատոր',
    'amenity_firesuppression'       => 'Հրդեհաշիջում',
    'amenity_electriccharging'      => 'Էլ. մեքենաների լիցքավորում',
    'amenity_fenced'                => 'Ցանկապատ',
    'amenity_roadaccess'            => 'Մուտք ճանապարհ',
    'amenity_well'                  => 'Հոր/ջրհոր',
    'amenity_septicsystem'          => 'Սեպտիկ',
    'amenity_buildingpermit'        => 'Շինթույլտվություն',
    ...
    'amenity_tv'              => 'Հեռուստացույց',
    'amenity_fridge'          => 'Սառնարան',
    'amenity_stove'           => 'Սալօջախ',
    'amenity_microwave'       => 'Միկրոալիքային վառարան',
    ...
    // Price history
    'price_listed_at'   => 'Տեղադրվել է',
    'price_changed_to'  => 'Գինը փոխվել է',
    'price_increased'   => 'Գինն աճել է',
    'price_decreased'   => 'Գինն իջել է',
    'no_price_history'  => 'Գնի պատմությունը հասանելի չէ:',
